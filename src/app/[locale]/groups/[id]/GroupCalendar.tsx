...
export default function GroupCalendar({ events, members, currentUserId, eventTypes, onEventUpdated, onEventDeleted, onDateClick, googleEventIds = [] }: GroupCalendarProps) {
